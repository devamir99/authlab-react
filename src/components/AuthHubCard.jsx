  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3 mb-4">
        <FlowIcon name={icon} box className="w-6 h-6" />
      ...
      <span className="inline-flex items-center gap-1.5 mt-4 text-sm font-medium text-primary">
        ...
        <FlowIcon
          name="arrow-right"
          className="w-4 h-4 transition-transform group-hover:translate-x-0.5 rtl:group-hover:-translate-x-0.5 rtl:rotate-180"
        />
      </span>
    </Link>
  );
