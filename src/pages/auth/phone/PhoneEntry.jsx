      ...
      <div className="max-w-md mx-auto px-4">
        ...
        <div className="surface rounded-2xl p-8 backdrop-blur-lg">
          <header className="mb-6 text-center">
            ...
            <h1 className="text-2xl font-bold text-app mb-2">{t('authHub.phone.pageTitle')}</h1>
            <p className="text-sm text-app-muted">{t('authHub.phone.pageSubtitle')}</p>
          </header>

          <p className="text-sm text-center text-app-muted mb-6 px-2 py-3 rounded-lg bg-[var(--color-primary-soft)]">
            {t('authHub.phone.comingPhase')}
          </p>
